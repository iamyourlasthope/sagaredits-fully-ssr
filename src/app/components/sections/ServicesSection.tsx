...
export default function ServicesSection() {
  return (
    <section className="relative w-full flex flex-col justify-center items-center py-8 sm:py-12 md:py-16 lg:py-12 xl:py-16 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 overflow-hidden bg-gradient-to-br from-[#0a232e] to-[#08222b] scroll-mt-20 sm:scroll-mt-0" id="services">
