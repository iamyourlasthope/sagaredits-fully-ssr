...
export default function ContactSection() {
  return (
    <section className="relative w-full min-h-screen flex flex-col justify-center items-center py-8 sm:py-12 md:py-16 lg:py-20 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 overflow-hidden bg-gradient-to-br from-[#0a232e] to-[#08222b]" id="contact">
